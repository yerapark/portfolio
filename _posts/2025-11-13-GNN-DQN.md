...
<!-- <div style="text-align: center;">
  <img src="{{'assets/img/favicons/graph1.png' | relative_url }}" 
       alt="Total Reward per Episode" 
       style="margin-bottom: 20px;">

  <img src="{{ 'assets/img/favicons/graph2.png' | relative_url }}" 
       alt="Reward Distribution" 
       style="margin-bottom: 20px;">
</div>

<div style="display: flex; justify-content: center; gap: 20px; margin: 30px 0;">
  <img src="{{ 'assets/img/favicons/pic1.png' | relative_url }}" 
       alt="Pic 1"
       style="border-radius: 6px;">

  <img src="{{ 'assets/img/favicons/pic2.png' | relative_url }}" 
       alt="Pic 2"
       style="border-radius: 6px;">
</div> -->

<!-- <div style="text-align: center;">
  <a href="{{ '/assets/img/favicons/graph1.png' | relative_url }}"
     class="popup img-link shimmer">
    <img src="{{ '/assets/img/favicons/graph1.png' | relative_url }}"
         alt="Total Reward per Episode"
         style="margin-bottom: 20px;"
  ...
  <a href="{{ '/assets/img/favicons/graph2.png' | relative_url }}"
     class="popup img-link shimmer">
    <img src="{{ '/assets/img/favicons/graph2.png' | relative_url }}"
         alt="Reward Distribution"
         style="margin-bottom: 20px;"
...
<div style="text-align: center;">
  <a href="{{ '/assets/img/favicons/graph1.png' | relative_url }}" class="popup img-link shimmer">
    <img src="{{ '/assets/img/favicons/graph1.png' | relative_url }}" 
         alt="Total Reward per Episode"
         style="margin-bottom: 20px;">
  </a>

  <a href="{{ '/assets/img/favicons/graph2.png' | relative_url }}" class="popup img-link shimmer">
    <img src="{{ '/assets/img/favicons/graph2.png' | relative_url }}" 
         alt="Reward Distribution"
         style="margin-bottom: 20px;">
  </a>
...
<div style="display: flex; justify-content: center; gap: 20px; margin: 30px 0;">
  <a href="{{ '/assets/img/favicons/pic1.png' | relative_url }}" class="popup img-link shimmer">
    <img src="{{ '/assets/img/favicons/pic1.png' | relative_url }}" 
         alt="Pic 1"
         style="border-radius: 6px;">
  </a>

  <a href="{{ '/assets/img/favicons/pic2.png' | relative_url }}" class="popup img-link shimmer">
    <img src="{{ '/assets/img/favicons/pic2.png' | relative_url }}" 
         alt="Pic 2"
         style="border-radius: 6px;">
  </a>
